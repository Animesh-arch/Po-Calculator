...
def create_frame(mode):
    ...
    if mode == 'n':
        ...
        button_del = tk.Button(frame, background="light gray", font=("Helvetica", 9, "bold"), text="<--", padx=31,
        ...
        button_add = tk.Button(frame, background="light gray", font=("Helvetica", 9, "bold"), text="+", padx=35, pady=5,
                               command=addition)
        button_clear = tk.Button(frame, background="light gray", font=("Helvetica", 9, "bold"), text="<--", padx=31,
                                 pady=5, command=delete)
        button_dot = tk.Button(frame, background="light gray", font=("Helvetica", 9, "bold"), text=".", padx=37, pady=5,
                               command=lambda: show("."))
        button_equal = tk.Button(frame, background="light gray", font=("Helvetica", 9, "bold"), text="=", padx=89,
...
if __name__ == "__main__":
    ...
    tk.Radiobutton(root, background="light gray", variable=mode, font=("Helvetica", 9, "bold"), text="Scientific",
                   value="s").grid(row=0, column=0, padx=5, pady=5, ipadx=10)
    tk.Radiobutton(root, background="light gray", variable=mode, font=("Helvetica", 9, "bold"), text="Simple",
                   value="n").grid(row=0, column=1, padx=5, pady=5, ipadx=10)

    choose_btn = tk.Button(root, background="light gray", width=10, font=("Helvetica", 9, "bold"), text="Select",
